...
source /home/work/ESP-IDF/export.sh >/tmp/esp32-flash.log
cd "$(dirname "$0")"

[[ -f build-6.0.2/esp32_blink.bin ]] || {
    echo "Нет готовой прошивки. Сначала выполните ./build.sh в examples/blink"
    exit 1
}
